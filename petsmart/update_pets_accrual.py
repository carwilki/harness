...
hjm.updateTargetSchema("PETSHOTEL_ACCRUAL", "qa_legacy")
hjm.updateTargetSchema("SKU_PROFILE", "qa_legacy")
hjm.updateTargetSchema("SITE_PROFILE", "qa_legacy")
hjm.updateTargetSchema("TP_INVOICE", "qa_refine")
hjm.updateTargetSchema("TP_INVOICE_SERVICE", "qa_refine")
